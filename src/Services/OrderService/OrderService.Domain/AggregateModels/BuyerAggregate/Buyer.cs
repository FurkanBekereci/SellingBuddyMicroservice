...
{
    public class Buyer : BaseEntity, IAggragateRoot
    {
                                                      ...
                                                      string securityNumber, string cardHolderName, DateTime expiration, Guid orderId)
        {
            ...
            var payment = existingPayment ?? new PaymentMethod(cardTypeId, alias, cardNumber, securityNumber, cardHolderName, expiration);
        ...
        {
            return base.Equals(obj) || (obj is Buyer buyer && Id.Equals(buyer.Id) && Name.Equals(buyer.Name));
        }
    }
}
